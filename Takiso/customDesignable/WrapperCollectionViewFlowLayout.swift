...
class WrapperCollectionViewFlowLayout: UICollectionViewFlowLayout {
    ...
    override func layoutAttributesForElements(in rect: CGRect) -> [UICollectionViewLayoutAttributes]? {
        ...
        guard let safeArray = super.layoutAttributesForElements(in: rect) else { return nil }
        guard let attributes = NSArray.init(array: safeArray, copyItems: true) as? [UICollectionViewLayoutAttributes] else { return nil }
